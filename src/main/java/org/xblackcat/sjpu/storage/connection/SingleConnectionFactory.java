...
public class SingleConnectionFactory implements IConnectionFactory {
    ...
    public SingleConnectionFactory(IConnectionFactory factory) throws SQLException {
        this.con = factory.getConnection();
        noCloseConnection = new NoCloseConnection(con);
    }

    @Override
    public Connection getConnection() throws SQLException {
        return noCloseConnection;
    }
     ...
     * @author xBlackCat
     */
    protected static class NoCloseConnection implements Connection {
