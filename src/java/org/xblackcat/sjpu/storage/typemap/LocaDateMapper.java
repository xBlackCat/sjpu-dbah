 ...
 * @author xBlackCat
 */
public class LocaDateMapper implements IMapFactory<LocalDate, Date> {
    private final ITypeMap<LocalDate, Date> typeMap = new NullPassTypeMap<>(LocalDate.class, Date.class, Date::valueOf, Date::toLocalDate);
